...
function notes_tab($FeedSlug, $object, $GeneralSettings, $PCITranscript, $PCITranscriptURL, $PCIChapters, $PCIChaptersURL, $PCISoundbites, $ExtraData)
{
    ...
    <div id="notes-<?php echo $FeedSlug; ?>" class="pp-tabcontent">
        ...
        <script language="javascript"><!--
            ...
            let <?php echo $FeedSlug; ?>_currentPersonCount = <?php echo $currentPersonCount; ?>;
            jQuery(document).ready(function() {
                ...
                jQuery("#powerpress-<?php echo $FeedSlug; ?> #tab-container-<?php echo $FeedSlug; ?>").on("click", "#<?php echo $FeedSlug; ?>-newperson", function (e) {
                    ...
                    let tempCount = <?php echo $FeedSlug; ?>_currentPersonCount + 1;
                    ...
                    if (<?php echo $FeedSlug; ?>_currentPersonCount == 0) {
                        jQuery(newHTML).insertBefore("#<?php echo $FeedSlug; ?>-add-person-container");
                    } else {
                        let prevId = '#<?php echo $FeedSlug; ?>-person-' + (<?php echo $FeedSlug; ?>_currentPersonCount) + '-container';
                ...
                jQuery("#powerpress-<?php echo $FeedSlug; ?> #tab-container-<?php echo $FeedSlug; ?>").on("click", "#<?php echo $FeedSlug; ?>-next-btn", function (e) {
                    <?php echo $FeedSlug; ?>_currentPersonCount += 1;
                    ...
                    if (selectedType !== "manual") {
                        defaultLightning = jQuery("#<?php echo $FeedSlug; ?>-person-" + <?php echo $FeedSlug; ?>_currentPersonCount + "-select-lightning").val().replace(/\s/g,'');
                    ...
                    if (!error) {
                        jQuery("#<?php echo $FeedSlug; ?>-person-select-"+<?php echo $FeedSlug; ?>_currentPersonCount).remove();
                        let newHTML = '<div class="row mt-4" id="<?php echo $FeedSlug; ?>-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-container" style="display: flex; align-items: center;">' +
                            '<div class="col">' +
                            '<div class="row" style="font-size: 110%; font-weight: bold;">' +
                            '<div class="col-lg-6 pl-0">' + <?php echo $FeedSlug; ?>_currentPersonCount + '. ' + defaultLightning + '</div>' +
                            '<div class="col-lg-3" style="display: flex; justify-content: flex-end;"><button class="value-btn float-right pl-0" type="button" style="border: none; background: inherit; color: red; font-size: 25px;" id="<?php echo $FeedSlug; ?>-remove-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '" name="<?php echo $FeedSlug; ?>-remove-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '">&times;</button></div>' +
                            '</div>' +
                            '<div class="row pl-0">' +
                            '<div class="col-lg-3 pl-0">' +
                            '<label style="font-size: 110%; font-weight: bold;" for="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-lightning"><?php echo __('Lightning Address / Name', 'powerpress'); ?></label>' +
                            '<br />' +
                            '<br />' +
                            '<input class="pp-ep-box-input" type="text" id="<?php echo $FeedSlug; ?>-ep-person-' +<?php echo $FeedSlug; ?>_currentPersonCount + '-lightning" name="Powerpress[<?php echo $FeedSlug; ?>][ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-lightning]" value="' + defaultLightning + '" />' +
                            '</div>' +
                            '<div class="col-lg-3 pl-0">' +
                            '<label style="font-size: 110%; font-weight: bold;" for="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-customkey"><?php echo __('Custom Key', 'powerpress'); ?></label>' +
                            '<br />' +
                            '<br />' +
                            '<input class="pp-ep-box-input" type="text" id="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-customkey" name="Powerpress[<?php echo $FeedSlug; ?>][ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-customkey]" value="' + defaultCustomKey + '" />' +
                            '</div>' +
                            '<div class="col-lg-3 pl-0">' +
                            '<label style="font-size: 110%; font-weight: bold;" for="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-customvalue"><?php echo __('Custom Value', 'powerpress'); ?></label>' +
                            '<br />' +
                            '<br />' +
                            '<input class="pp-ep-box-input" type="text" id="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-customvalue" name="Powerpress[<?php echo $FeedSlug; ?>][ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-customvalue]" value="' + defaultCustomValue + '" />' +
                            '</div>' +
                            '</div>' +
                            '<div class="row pl-0" style="margin-top: 20px;">' +
                            '<div class="col-lg-6 pl-0">' +
                            '<label style="font-size: 110%; font-weight: bold;" for="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-pubkey"><?php echo __('PubKey', 'powerpress'); ?></label>' +
                            '<br />' +
                            '<br />' +
                            '<input class="pp-ep-box-input" type="text" id="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-pubkey" name="Powerpress[<?php echo $FeedSlug; ?>][ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-pubkey]" value="' + defaultPubKey + '" />' +
                            '</div>' +
                            '<div class="col-lg-3">' +
                            '<label style="font-size: 110%; font-weight: bold;" for="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-split"><?php echo __('Split', 'powerpress'); ?></label>' +
                            '<br />' +
                            '<br />' +
                            '<input class="pp-ep-box-input" type="number" id="<?php echo $FeedSlug; ?>-ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-split" name="Powerpress[<?php echo $FeedSlug; ?>][ep-person-' + <?php echo $FeedSlug; ?>_currentPersonCount + '-split]" />' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>';

                        if (<?php echo $FeedSlug; ?>_currentPersonCount == 1) {
                            jQuery(newHTML).insertBefore("#<?php echo $FeedSlug; ?>-add-person-container");
                        } else {
                            let prevId = '#<?php echo $FeedSlug; ?>-person-' + (<?php echo $FeedSlug; ?>_currentPersonCount - 1) + '-container';
                            jQuery(newHTML).insertAfter(prevId);
                        }
                        jQuery("#<?php echo $FeedSlug; ?>-newperson").css({"display": "block"});
                    } else {
        ...
        <div class="pp-section-container col-lg-4 pl-0" style="padding-left: 0;">
            ...
            <div class="powerpress_row_content">
                ...
                <input class="pp-ep-box-input" type="text" name="Powerpress[<?php echo $FeedSlug; ?>][location]" oninput="<?php echo $FeedSlug; ?>_powerpress_locationInput(event)" value="<?php echo isset($ExtraData['location']) ? esc_attr($ExtraData['location']) : ""; ?>" maxlength="50" />
        ...
        <?php } ?>
        <script>
            function <?php echo $FeedSlug; ?>_powerpress_locationInput(event){
            ...
            let <?php echo $FeedSlug; ?>_currentRoleCount = <?php echo $currentRoleCount; ?>;

            jQuery(document).ready(function() {
                jQuery(document).on('click',"[name*='<?php echo $FeedSlug; ?>-remove-role-']",function (e) {
                    <?php echo $FeedSlug; ?>_currentRoleCount -= 1;
                ...
                jQuery("[name='<?php echo $FeedSlug; ?>-newrole']").click(function (e) {
                    ...
                    let newHTML = '<div id="<?php echo $FeedSlug; ?>-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-container">' +
                        '<div class="row">' +
                        '<div class="col-lg-2">' +
                        '<label for="<?php echo $FeedSlug; ?>-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-name" style="margin: 0;"><?php echo __("Author/Artist", "powerpress"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-1" style="padding: 0;">' +
                        '<label for="<?php echo $FeedSlug; ?>-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-role" style="margin: 0;"><?php echo __("Role", "powerpress"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-3">' +
                        '<label for="<?php echo $FeedSlug; ?>-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-personurl" style="margin: 0;"><?php echo __("Person Image URL", "powerpress"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-3">' +
                        '<label for="<?php echo $FeedSlug; ?>-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-linkurl" style="margin: 0;"><?php echo __("Link URL", "powerpress"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-1"></div>' +
                        '</div>' +
                        '<div class="row" style="display: flex; align-items: center;">' +
                        ...
                        '<div class="row" style="display: flex; align-items: center; margin-bottom: 15px;">' +
                        '<div class="col-lg-2">' +
                        '<input type="text" value="" id="<?php echo $FeedSlug; ?>-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-name" name="Powerpress[<?php echo $FeedSlug; ?>][role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-name]" class="pp-ep-box-input" />' +
                        '</div>' +
                        '<div class="col-lg-1" style="padding: 0;">' +
                        '<select name="Powerpress[<?php echo $FeedSlug; ?>][role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-role]" class="pp-ep-box-input" style="width: 100% !important;" aria-label="Default select example">' +
                        '<?php printSelectOptionsRoles("Guest");  ?>' +
                        '</select>' +
                        '</div>' +
                        '<div class="col-lg-3">' +
                        '<input type="text" value="" name="Powerpress[<?php echo $FeedSlug; ?>][role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-personurl]" class="pp-ep-box-input"/>' +
                        '</div>' +
                        '<div class="col-lg-3">' +
                        '<input type="text" value="" name="Powerpress[<?php echo $FeedSlug; ?>][role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '-linkurl]" class="pp-ep-box-input"/>' +
                        '</div>' +
                        '<div class="col-lg-1 pl-0">' +
                        '<button class="float-left pl-0" type="button" style="border: none; background: inherit; color: red; font-size: 25px;" id="<?php echo $FeedSlug; ?>-remove-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '" name="<?php echo $FeedSlug; ?>-remove-role-' + <?php echo $FeedSlug; ?>_currentRoleCount + '">&times;</button>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>';
                    let prevId = '#<?php echo $FeedSlug; ?>-role-' + (<?php echo $FeedSlug; ?>_currentRoleCount - 1) + '-container';
                    jQuery(newHTML).insertAfter(prevId)
                });
            });
        </script>
